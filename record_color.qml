            ...
            ScrollView {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        ...
                        ComboBox {
                            model: ["Balance White Auto Off", "Balance White Auto Once", "Balance White Auto Continuous"]
                            enabled: configuration?.recording_name == null
                            onCurrentIndexChanged: {
                                if (currentIndex === 0) {
                                    configuration.balance_white_auto = "Off";
                                } else if (currentIndex === 1) {
                                    configuration.balance_white_auto = "Once";
                                } else if (currentIndex === 2) {
                                    configuration.balance_white_auto = "Continuous";
                                }
                            }
                        }
                    }
